					...
					<div class="row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="ne_sport_slider_wrapper ne_sport_slider_wrapper_single">
								...
								<p>&nbsp;</p>
								<form class="form-horizontal form2" id="form" name="dadosMJ" onSubmit="return checa_formulario();" action="https://revistamundologistic.websiteseguro.com/EdicoesAnteriores.jsp" method="POST" accept-charset="ISO-8859-1">
								<?
								...
								if (mysqli_num_rows($sql)) {
									...
									while ($d = mysqli_fetch_array($sql)) {
										...
										print "<div class='col-md-6'>
											...
											<div class='col-md-4'>
												<label>Quantidade</label> <input type='text' name='edicao".$l."' value='0' onKeyPress='Mascara(this,Integer);' />
											</div>
											</div>
											</div>
										</div>\n";
